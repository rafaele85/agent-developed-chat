...
- iter-007: Username entry flow
- iter-008: Message sending/receiving
- iter-009: User list display
...
## Notes
- Each iteration should take 30-60 minutes maximum
- Never combine backend + frontend work in same iteration
- Always write tests before marking iteration complete
- Update this file after completing each iteration